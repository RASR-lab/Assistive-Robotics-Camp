...
Instructions for setting up the Raspberry Pi Pico and programming it using MicroPython can be found [here](https://projects.raspberrypi.org/en/projects/getting-started-with-the-pico)

### Notes: 
[Assistive_Robotics_P1.pptx](Part%201/Assistive_Robotics_P1.pptx)
...
### Notes:
[Assistive_Robotics_P2.pptx](Part%202/Assistive_Robotics_P2.pdf)
